    ...
    <div className="w-full bg-primary-background min-h-screen">
      ...
      <section className="w-full flex flex-col items-center justify-center relative overflow-hidden px-4 sm:px-6 lg:px-8 py-20 md:py-32">
        ...
        <div aria-hidden="true" className="absolute inset-0 -z-10">
          <div className="absolute top-[10%] right-[15%] h-[400px] w-[400px] rounded-full bg-purple-600/[0.04] blur-[100px]" />
          <div className="absolute bottom-[20%] left-[15%] h-[400px] w-[400px] rounded-full bg-cyan-500/[0.04] blur-[100px]" />
        </div>
