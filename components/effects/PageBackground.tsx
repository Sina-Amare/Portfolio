...
const commits = [
  ...
  { msg: "feat: views", ms: false },
  { msg: "feat: DRF", ms: true },
  { msg: "learn: postgres", ms: false },
  { msg: "feat: auth", ms: false },
  { msg: "learn: docker", ms: false },
  // 2023 - Bachelor's thesis
  { msg: "research: PSO", ms: true },
  { msg: "impl: swarm", ms: false },
  { msg: "test: optimize", ms: false },
  { msg: "docs: thesis", ms: true },
  // 2024 - Arnikup
  { msg: "job: arnikup", ms: true },
  { msg: "feat: food API", ms: false },
  { msg: "feat: orders", ms: false },
  { msg: "perf: n+1 fix", ms: false },
  { msg: "docs: swagger", ms: false },
  { msg: "setup: compose", ms: true },
  { msg: "feat: redis", ms: false },
  { msg: "ship: delivery", ms: false },
  // 2025 - Dekamond
  { msg: "job: dekamond", ms: true },
  { msg: "feat: langgraph", ms: false },
  { msg: "feat: MCP srv", ms: false },
  { msg: "arch: RAG pipe", ms: true },
  { msg: "feat: notion AI", ms: false },
  { msg: "perf: -70% cost", ms: false },
  { msg: "feat: HR bot", ms: false },
  { msg: "feat: review bot", ms: true },
  { msg: "feat: kaleri", ms: false },
  { msg: "scrape: foods", ms: false },
  { msg: "feat: support", ms: false },
  // Present - Portfolio
  { msg: "build: portfolio", ms: true },
  { msg: "feat: terminal", ms: false },
  { msg: "feat: timeline", ms: false },
  { msg: "style: effects", ms: false },
  // Call to action
